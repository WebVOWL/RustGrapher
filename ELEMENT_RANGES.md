...
This document details the conversion of element enums to number codes for all visualized types. The following numbers can store the code of an element enum:
